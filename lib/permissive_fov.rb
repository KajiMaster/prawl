...
# this code from
# http://roguebasin.roguelikedevelopment.org/index.php/Ruby_precise_permissive_FOV_implementation
# It is based on the Python implementation by Aaron MacDonald.
# http://roguebasin.roguelikedevelopment.org/index.php/Permissive_Field_of_View_in_Python
...
module PermissiveFieldOfView
    ...
    def do_fov(start_x, start_y, radius)
        ...
        max_extent_x = [w - @start_x - 1, radius].min
        min_extent_y = [@start_y, radius].min
        max_extent_y = [h - @start_y - 1, radius].min
